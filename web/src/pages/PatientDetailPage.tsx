...
export function PatientDetailPage() {
  ...
  return <div className="page patient-workspace">
    <nav className="patient-workspace__breadcrumb" aria-label={t("pd.backToPatients")}><Link className="patient-workspace__back" to="/patients"><span aria-hidden="true">←</span>{t("patients.title")}</Link><span aria-hidden="true">/</span><strong>{name}</strong></nav>
