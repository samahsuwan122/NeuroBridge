...
// 2) Required professional-copy wording must be present (product-focused: a
//    connected care platform for patients, families, and care teams).
console.log("Professional copy present:");
const mustInclude = [
...
// 3) Forbidden unsafe medical-claim terms must NOT appear.
console.log("No unsafe medical claims:");
const forbidden = [
  "diagnose", "diagnosis", "treatment recommendation", "disease prediction",
  "risk score", "automated medical decision", "medical decision-making",
];
