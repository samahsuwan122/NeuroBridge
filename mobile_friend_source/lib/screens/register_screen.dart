  ...
  Widget _buildConfirmPasswordField() {
    return TextFormField(
      ...
      decoration: _inputDecoration(
        ...
        suffixIcon: IconButton(
          tooltip:
              _hideConfirmPassword ? 'إظهار' : 'إخفاء',
          onPressed: () {
            setState(() {
