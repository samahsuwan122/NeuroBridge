...
class PatientHomeScreen extends StatelessWidget {
  ...
  static const Color roseDark = AppColors.primaryDark;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color(0xFFD8C5A9),
                ),
                boxShadow: [
                  BoxShadow(
                    color: rose.withValues(alpha: 0.16),
                    blurRadius: 28,
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: const LinearProgressIndicator(
                      value: 0.68,
                      minHeight: 9,
                      backgroundColor: Color(0xFFDECDB7),
                ...
                _QuickAction(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const MemoryTreeScreen(),
                      ),
                    );
                  },
                ),
            ...
            PatientSectionTitle(
              ...
              onAction: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const EncouragementScreen(),
                  ),
                );
              },
            ),
