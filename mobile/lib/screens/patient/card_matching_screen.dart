          ...
          child: Column(
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (_, index) {
                  final visible =
                      opened.contains(index) || matched.contains(index);
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: visible ? Colors.white : const Color(0xFF4A3528),
                        borderRadius: BorderRadius.circular(18),
                        border: Border.all(
                          color: const Color(0xFFD7C3A6),
                        ),
                      ),
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: visible ? brown : Colors.white,
                          fontWeight: FontWeight.w900,
                        ),
                      ),
                    ),
