...
class _AiAssistantScreenState extends State<AiAssistantScreen> {
  static const Color _rose = Color(0xFF4A3528);
  static const Color _brown = Color(0xFF35251C);
  static const Color _muted = Color(0xFF76665A);
  static const Color _border = Color(0xFFE4D8C8);
  ...
  String _generateDemoReply(String question) {
    ...
    if (q.contains('تمرين') || q.contains('exercise')) {
    ...
    if (q.contains('تقدم') || q.contains('تقدّم') || q.contains('progress')) {
      return 'من صفحة "تقدّمي" يمكنك مشاهدة الجلسات المكتملة، وقت التدريب، النشاط الأسبوعي والإنجازات التي حققتها. 📈';
    }

    if (q.contains('عائلة') || q.contains('مرافق') || q.contains('family')) {
    ...
    if (q.contains('حساب') || q.contains('account')) {
            ...
            onPressed: () {
              setState(() {
                _messages
                  ...
                  ..add(
                    const _ChatMessage(
                      text: 'بدأنا محادثة جديدة 🌷 كيف يمكنني مساعدتك؟',
                      fromUser: false,
                    ),
                  );
              });
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            fontSize: 13,
            height: 1.7,
            color: message.fromUser ? Colors.white : const Color(0xFF5F4B47),
          ),
        ),
      ),
    );
