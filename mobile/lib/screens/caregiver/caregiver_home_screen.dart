          ...
          child: Column(
            ...
            children: [
                  ...
                  _HomeAction(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const SendEncouragementScreen(),
                        ),
                      );
                    },
                  ),
                  ...
                  _HomeAction(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const FamilyProgressScreen(),
                        ),
                      );
                    },
                  ),
                  _HomeAction(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const FamilyAppointmentsScreen(),
                        ),
                      );
                    },
                  ),
              ...
              CaregiverMenuTile(
                ...
                title: 'ملخص سامي',
                subtitle: 'جلسة اليوم والالتزام الأسبوعي والموعد القادم',
                color: CaregiverColors.rose,
                onTap: () {
                  Navigator.push(
                    context,
              ...
              CaregiverMenuTile(
                ...
                title: 'آخر النشاط',
                subtitle: 'آخر التمارين والجلسات المكتملة',
                color: CaregiverColors.blue,
                onTap: () {
                  Navigator.push(
                    context,
              ...
              CaregiverMenuTile(
                ...
                subtitle: 'موعد غدًا • 3 أيام متتالية',
                color: CaregiverColors.gold,
                onTap: () {
                  Navigator.push(
                    context,
              ...
              CaregiverMenuTile(
                ...
                subtitle: 'التمرين والمواعيد والأنشطة اليومية',
              ...
              CaregiverMenuTile(
                ...
                subtitle: 'إدارة الصور والذكريات العائلية',
                color: CaregiverColors.green,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const FamilyMemoryAlbumScreen(),
                    ),
                  );
                },
              ),
              ...
              CaregiverMenuTile(
                ...
                title: 'ربط مريض',
                subtitle: 'رمز دعوة أو QR أو طلب ارتباط',
                color: CaregiverColors.blue,
                onTap: () {
                  Navigator.push(
                    context,
              ...
              CaregiverMenuTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const CaregiverGuideScreen(),
                    ),
                  );
                },
              ),
              ...
              CaregiverMenuTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const CaregiverWellbeingScreen(),
                    ),
                  );
                },
              ),
              ...
              CaregiverMenuTile(
                ...
                title: 'الصلاحيات',
                subtitle: 'ما الذي يسمح لك المريض برؤيته',
                color: CaregiverColors.purple,
                onTap: () {
                  Navigator.push(
                    context,
