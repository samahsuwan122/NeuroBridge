...
class CaregiverWellbeingScreen extends StatefulWidget {
  const CaregiverWellbeingScreen({
    super.key,
  });

  @override
  State<CaregiverWellbeingScreen> createState() =>
      _CaregiverWellbeingScreenState();
}

class _CaregiverWellbeingScreenState extends State<CaregiverWellbeingScreen> {
  String? mood;
          ...
          child: Column(
            ...
            children: [
              const CaregiverHeader(
                title: 'رفاه المرافق',
                subtitle: 'العناية بنفسك جزء مهم من قدرتك على تقديم الدعم.',
              ),
              ...
              CaregiverMenuTile(
                ...
                title: 'مصادر دعم',
                subtitle: 'محتوى تعليمي ومصادر للمرافقين',
