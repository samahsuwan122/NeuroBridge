...
class FamilyPermissionsScreen extends StatefulWidget {
  ...
  @override
  State<FamilyPermissionsScreen> createState() =>
          ...
          child: Column(
            children: [
              const CaregiverHeader(
                title: 'صلاحياتي',
                subtitle: 'هذه الصلاحيات يحددها المريض أو المسؤول المخوّل.',
              ),
    ...
    return Padding(
      ...
      child: CaregiverCard(
        child: Row(
          children: [
            Icon(
              value ? Icons.check_circle_rounded : Icons.lock_outline_rounded,
              color: value ? CaregiverColors.green : CaregiverColors.muted,
            ),
