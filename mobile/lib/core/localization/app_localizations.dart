...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'de': {
      ...
      'sequenceRecallNote':
          'Diese Aktivität misst nur die Spielleistung und ist keine medizinische Beurteilung.',
      'homeSupportiveMessage':
          'Kleine Schritte jeden Tag machen einen Unterschied.',
      'invalidLogin': 'E-Mail/Telefon oder Passwort ist falsch.',
      'networkError': 'Server nicht erreichbar. Bitte erneut versuchen.',
      'rolesLabel': 'Rollen',
      'fieldRequired': 'Dieses Feld ist erforderlich.',
      'todayTherapyDesc': 'Deine Therapieaktivitäten für heute.',
      'cognitiveGamesDesc': 'Übungen für Gedächtnis und Aufmerksamkeit.',
      'progressDesc': 'Sieh, wie du dich mit der Zeit entwickelst.',
      'remindersDesc': 'Erinnerungen für Medikamente und Termine.',
      'myProfileDesc': 'Zeige deine Profildaten an.',
      'memoryAlbumDesc': 'Fotos und Geschichten aus deinem Leben.',
      'familySupportDesc': 'Bleib mit deinen Betreuern verbunden.',
      'noPatientProfile': 'Noch kein Patientenprofil verknüpft.',
      'profileLoadError':
      ...
      'noGamesAvailable': 'Noch keine Spiele verfügbar.',
      'gamesLoadError':
          'Spiele konnten nicht geladen werden. Bitte erneut versuchen.',
      'estimatedDuration': 'Geschätzte Dauer',
      'gamePlayComingLater':
          'Das Spiel wird in einer späteren Phase hinzugefügt.',
      'moves': 'Züge',
      'matches': 'Paare',
      'mistakes': 'Fehler',
      'time': 'Zeit',
      ...
      'performanceOnlyNote':
          'Dies ist eine kognitive Übung. Die Punkte spiegeln nur die Spielleistung wider.',
      ...
      'progressSubtitle': 'Deine letzte Übungsleistung.',
      'loadingProgress': 'Dein Fortschritt wird geladen…',
      'progressLoadFailed':
          'Dein Fortschritt konnte nicht geladen werden. Bitte erneut versuchen.',
      'score': 'Punktzahl',
      'duration': 'Dauer',
      ...
      'date': 'Datum',
      'performanceOnlyProgressNote':
          'Dies sind Ergebnisse kognitiver Übungen (nur Spielleistung), keine medizinische Beurteilung.',
      'noResultsYet': 'Noch keine Ergebnisse.',
      'profileSubtitle': 'Deine grundlegenden Profildaten.',
      ...
      'mobilityNeeds': 'Mobilitätsbedürfnisse',
      'visionHearingNeeds': 'Seh-/Hörbedürfnisse',
      'preferredCommunication': 'Bevorzugte Kommunikation',
      'caregiverNotes': 'Notizen der Betreuer',
      'memoryAlbumSubtitle': 'Wertvolle Erinnerungen mit deiner Familie.',
      'loadingMemories': 'Erinnerungen werden geladen…',
      'memoriesLoadFailed':
          'Erinnerungen konnten nicht geladen werden. Bitte erneut versuchen.',
      'personName': 'Person',
      ...
      'memoryTitle': 'Titel',
      'memoryDescription': 'Beschreibung',
      'memoryTitleRequired': 'Bitte gib einen Titel ein.',
      'memorySaved': 'Erinnerung gespeichert.',
      'memorySaveFailed':
          'Erinnerung konnte nicht gespeichert werden. Bitte erneut versuchen.',
      'optional': 'Optional',
      'submitting': 'Wird gespeichert…',
      'memoryDateHint': 'JJJJ-MM-TT',
      'mediaUrlHint': 'Link oder Notiz (optional)',
      'changeImage': 'Bild ändern',
      'imageSelected': 'Ausgewähltes Bild',
      'imageRequirements': 'JPEG, PNG oder WebP bis 5 MB.',
      'imageUploadFailed':
          'Bild konnte nicht hochgeladen werden. Bitte erneut versuchen.',
      'imageUploadSuccess': 'Erinnerung und Bild gespeichert.',
      'unsupportedImageType':
          'Nicht unterstützter Bildtyp. Verwende JPEG, PNG oder WebP.',
      'imageTooLarge': 'Das Bild ist zu groß (maximal 5 MB).',
      'memoryCreatedImageFailed':
          'Erinnerung gespeichert, aber das Bild konnte nicht hochgeladen werden. Du kannst es später hinzufügen.',
      'imagePreview': 'Bildvorschau',
      'imageUnavailable': 'Bild nicht verfügbar',
      'memoryImage': 'Erinnerungsbild',
      'noImageAttached': 'Kein Bild angehängt',
      'memoryRecall': 'Erinnerungsabruf',
      'memoryRecallSubtitle': 'Erinnere dich an Momente aus deinem Album.',
      'whoIsThisPerson': 'Wer ist diese Person?',
      'whereWasThisMemory': 'Wo war diese Erinnerung?',
      'whatCategoryIsThisMemory': 'Zu welcher Kategorie gehört diese Erinnerung?',
      'correct': 'Richtig',
      'tryAgain': 'Erneut versuchen',
      'nextQuestion': 'Nächste Frage',
      'finishExercise': 'Beenden',
      'recallComplete': 'Übung abgeschlossen',
      'recallScore': 'Deine Punktzahl',
      'notEnoughMemories': 'Noch nicht genügend Erinnerungen',
      'addMoreMemoriesToStart':
          'Füge weitere Erinnerungen hinzu, um diese Übung zu starten.',
      'memoryRecallLoadFailed':
          'Erinnerungsabruf konnte nicht gestartet werden. Bitte erneut versuchen.',
      'reactionTime': 'Reaktionszeit',
      'reactionTimeSubtitle':
          'Tippe so schnell wie möglich, wenn das Signal erscheint.',
      'startRound': 'Runde starten',
      'waitForSignal': 'Warten…',
      'tapNow': 'Jetzt tippen!',
      'tooSoon': 'Zu früh! Warte auf das Signal.',
      'reactionTimeMs': 'Reaktionszeit',
      'bestReaction': 'Beste',
      'averageReaction': 'Durchschnitt',
      'roundsCompleted': 'Runden',
      'reactionComplete': 'Übung abgeschlossen',
      'attentionTap': 'Aufmerksamkeitstippen',
      'attentionTapSubtitle': 'Tippe auf das Ziel und ignoriere den Rest.',
      'startAttentionTap': 'Starten',
      'tapTheTarget': 'Tippe auf das Ziel',
      'target': 'Ziel',
      'correctTap': 'Richtig!',
      'missedTarget': 'Das war nicht das Ziel',
      'mistake': 'Fehler',
      'accuracy': 'Genauigkeit',
      'attentionComplete': 'Übung abgeschlossen',
      'correctCount': 'Richtig',
      'sequenceRecall': 'Sequenzabruf',
      'sequenceRecallSubtitle':
          'Beobachte die Sequenz und wiederhole sie in der Reihenfolge.',
      'startSequenceRecall': 'Starten',
      'watchSequence': 'Beobachte die Sequenz',
      'repeatSequence': 'Wiederhole die Sequenz',
      'correctSequence': 'Richtig!',
      'wrongSequence': 'Nicht ganz',
      'longestSequence': 'Längste',
      'sequenceComplete': 'Übung abgeschlossen',
    },
    'tr': {
      ...
      'sequenceRecallNote':
          'Bu etkinlik yalnızca oyun performansını ölçer ve tıbbi bir değerlendirme değildir.',
      'homeSupportiveMessage': 'Her gün atılan küçük adımlar fark yaratır.',
      'invalidLogin': 'E-posta/telefon veya şifre yanlış.',
      'networkError': 'Sunucuya ulaşılamıyor. Lütfen tekrar deneyin.',
      'rolesLabel': 'Roller',
      'fieldRequired': 'Bu alan zorunludur.',
      'todayTherapyDesc': 'Bugünkü terapi etkinlikleriniz.',
      'cognitiveGamesDesc': 'Bellek ve dikkat için egzersizler.',
      'progressDesc': 'Zaman içindeki ilerlemenizi görün.',
      'remindersDesc': 'İlaç ve randevu hatırlatıcıları.',
      'myProfileDesc': 'Profil bilgilerinizi görüntüleyin.',
      'memoryAlbumDesc': 'Hayatınızdan fotoğraflar ve hikâyeler.',
      'familySupportDesc': 'Bakıcılarınızla bağlantıda kalın.',
      'noPatientProfile': 'Henüz bağlı bir hasta profili yok.',
      'profileLoadError': 'Profiliniz yüklenemedi. Lütfen tekrar deneyin.',
      'emergencyContact': 'Acil durum kişisi',
      'medicalCenter': 'Tıp merkezi',
      'loadingGames': 'Oyunlar yükleniyor…',
      'noGamesAvailable': 'Henüz oyun yok.',
      'gamesLoadError': 'Oyunlar yüklenemedi. Lütfen tekrar deneyin.',
      'estimatedDuration': 'Tahmini süre',
      'gamePlayComingLater': 'Oyun daha sonraki bir aşamada eklenecek.',
      'moves': 'Hamleler',
      'matches': 'Eşleşmeler',
      'mistakes': 'Hatalar',
      'time': 'Süre',
      ...
      'performanceOnlyNote':
          'Bu bir bilişsel egzersizdir. Puanlar yalnızca oyun performansını yansıtır.',
      'savingResult': 'Sonuç kaydediliyor…',
      'resultSaved': 'Sonuç kaydedildi',
      'resultSaveFailed': 'Sonuç kaydedilemedi.',
      'retrySave': 'Yeniden dene',
      'progressSubtitle': 'Son egzersiz performansınız.',
      'loadingProgress': 'İlerlemeniz yükleniyor…',
      'progressLoadFailed': 'İlerlemeniz yüklenemedi. Lütfen tekrar deneyin.',
      'score': 'Puan',
      'duration': 'Süre',
      ...
      'date': 'Tarih',
      'performanceOnlyProgressNote':
          'Bunlar bilişsel egzersiz sonuçlarıdır (yalnızca oyun performansı), tıbbi bir değerlendirme değildir.',
      'noResultsYet': 'Henüz sonuç yok.',
      'profileSubtitle': 'Temel profil bilgileriniz.',
      'loadingProfile': 'Profiliniz yükleniyor…',
      'profileLoadFailed': 'Profiliniz yüklenemedi. Lütfen tekrar deneyin.',
      'dateOfBirth': 'Doğum tarihi',
      'gender': 'Cinsiyet',
      'memberSince': 'Üyelik başlangıcı',
      'mobilityNeeds': 'Hareket ihtiyaçları',
      'visionHearingNeeds': 'Görme/işitme ihtiyaçları',
      'preferredCommunication': 'Tercih edilen iletişim',
      'caregiverNotes': 'Bakıcı notları',
      'memoryAlbumSubtitle': 'Ailenizle değerli anılar.',
      'loadingMemories': 'Anılar yükleniyor…',
      'memoriesLoadFailed': 'Anılar yüklenemedi. Lütfen tekrar deneyin.',
      'personName': 'Kişi',
      ...
      'memoryTitle': 'Başlık',
      'memoryDescription': 'Açıklama',
      'memoryTitleRequired': 'Lütfen bir başlık girin.',
      'memorySaved': 'Anı kaydedildi.',
      'memorySaveFailed': 'Anı kaydedilemedi. Lütfen tekrar deneyin.',
      'optional': 'İsteğe bağlı',
      'submitting': 'Kaydediliyor…',
      'memoryDateHint': 'YYYY-AA-GG',
      'mediaUrlHint': 'Bağlantı veya not (isteğe bağlı)',
      'changeImage': 'Görseli değiştir',
      'imageSelected': 'Seçilen görsel',
      'imageRequirements': 'JPEG, PNG veya WebP, en fazla 5 MB.',
      'imageUploadFailed': 'Görsel yüklenemedi. Lütfen tekrar deneyin.',
      'imageUploadSuccess': 'Anı ve görsel kaydedildi.',
      'unsupportedImageType':
          'Desteklenmeyen görsel türü. JPEG, PNG veya WebP kullanın.',
      'imageTooLarge': 'Görsel çok büyük (en fazla 5 MB).',
      'memoryCreatedImageFailed':
          'Anı kaydedildi ancak görsel yüklenemedi. Daha sonra ekleyebilirsiniz.',
      'imagePreview': 'Görsel önizlemesi',
      'imageUnavailable': 'Görsel kullanılamıyor',
      'memoryImage': 'Anı görseli',
      'noImageAttached': 'Görsel eklenmedi',
      'memoryRecall': 'Anı hatırlama',
      'memoryRecallSubtitle': 'Anı albümünüzden anları hatırlayın.',
      'whoIsThisPerson': 'Bu kişi kim?',
      'whereWasThisMemory': 'Bu anı nerede yaşandı?',
      'whatCategoryIsThisMemory': 'Bu anı hangi kategoriye ait?',
      'correct': 'Doğru',
      'tryAgain': 'Tekrar dene',
      'nextQuestion': 'Sonraki soru',
      'finishExercise': 'Bitir',
      'recallComplete': 'Egzersiz tamamlandı',
      'recallScore': 'Puanınız',
      'notEnoughMemories': 'Henüz yeterli anı yok',
      'addMoreMemoriesToStart':
          'Bu egzersize başlamak için daha fazla anı ekleyin.',
      'memoryRecallLoadFailed':
          'Anı hatırlama başlatılamadı. Lütfen tekrar deneyin.',
      'reactionTime': 'Tepki süresi',
      'reactionTimeSubtitle':
          'İşaret belirdiğinde olabildiğince hızlı dokunun.',
      'startRound': 'Tura başla',
      'waitForSignal': 'Bekleyin…',
      'tapNow': 'Şimdi dokunun!',
      'tooSoon': 'Çok erken! İşareti bekleyin.',
      'reactionTimeMs': 'Tepki süresi',
      'bestReaction': 'En iyi',
      'averageReaction': 'Ortalama',
      'roundsCompleted': 'Turlar',
      'reactionComplete': 'Egzersiz tamamlandı',
      'attentionTap': 'Dikkat dokunuşu',
      'attentionTapSubtitle': 'Hedefe dokunun, gerisini yok sayın.',
      'startAttentionTap': 'Başla',
      'tapTheTarget': 'Hedefe dokunun',
      'target': 'Hedef',
      'correctTap': 'Doğru!',
      'missedTarget': 'Bu hedef değildi',
      'mistake': 'Hata',
      'accuracy': 'Doğruluk',
      'attentionComplete': 'Egzersiz tamamlandı',
      'correctCount': 'Doğru',
      'sequenceRecall': 'Sıra hatırlama',
      'sequenceRecallSubtitle': 'Sırayı izleyin, ardından sırasıyla tekrarlayın.',
      'startSequenceRecall': 'Başla',
      'watchSequence': 'Sırayı izleyin',
      'repeatSequence': 'Sırayı tekrarlayın',
      'correctSequence': 'Doğru!',
      'wrongSequence': 'Tam değil',
      'longestSequence': 'En uzun',
      'sequenceComplete': 'Egzersiz tamamlandı',
    },
    'pt': {
      'loginTitle': 'Entrar',
      ...
      'invalidLogin': 'E-mail/telefone ou senha incorretos.',
      'networkError': 'Não foi possível conectar ao servidor. Tente novamente.',
      'rolesLabel': 'Funções',
      'fieldRequired': 'Este campo é obrigatório.',
      'todayTherapyDesc': 'Suas atividades de terapia de hoje.',
      'cognitiveGamesDesc': 'Exercícios para memória e atenção.',
      'progressDesc': 'Acompanhe seu progresso ao longo do tempo.',
      'remindersDesc': 'Lembretes de medicamentos e consultas.',
      'myProfileDesc': 'Veja os detalhes do seu perfil.',
      'memoryAlbumDesc': 'Fotos e histórias da sua vida.',
      'familySupportDesc': 'Mantenha contato com seus cuidadores.',
      'noPatientProfile': 'Nenhum perfil de paciente vinculado ainda.',
      'profileLoadError':
          'Não foi possível carregar seu perfil. Tente novamente.',
      'emergencyContact': 'Contato de emergência',
      'medicalCenter': 'Centro médico',
      'loadingGames': 'Carregando jogos…',
      'noGamesAvailable': 'Ainda não há jogos disponíveis.',
      'gamesLoadError': 'Não foi possível carregar os jogos. Tente novamente.',
      'estimatedDuration': 'Duração estimada',
      'gamePlayComingLater': 'O jogo será adicionado em uma fase posterior.',
      'moves': 'Jogadas',
      'matches': 'Pares',
      'mistakes': 'Erros',
      'time': 'Tempo',
      'wellDone': 'Muito bem!',
      'gameSummary': 'Resumo do jogo',
      'performanceOnlyNote':
          'Este é um exercício cognitivo. As pontuações refletem apenas o desempenho do jogo.',
      'savingResult': 'Salvando resultado…',
      'resultSaved': 'Resultado salvo',
      'resultSaveFailed': 'Não foi possível salvar o resultado.',
      'retrySave': 'Tentar novamente',
      'progressSubtitle': 'Seu desempenho recente nos exercícios.',
      ...
      'date': 'Data',
      'performanceOnlyProgressNote':
          'Estes são resultados de exercícios cognitivos (apenas desempenho do jogo), não uma avaliação médica.',
      'noResultsYet': 'Ainda não há resultados.',
      'profileSubtitle': 'As informações básicas do seu perfil.',
      ...
      'mobilityNeeds': 'Necessidades de mobilidade',
      'visionHearingNeeds': 'Necessidades de visão/audição',
      'preferredCommunication': 'Comunicação preferida',
      'caregiverNotes': 'Notas do cuidador',
      'memoryAlbumSubtitle': 'Memórias preciosas com sua família.',
      ...
      'memoryTitle': 'Título',
      'memoryDescription': 'Descrição',
      'memoryTitleRequired': 'Digite um título.',
      'memorySaved': 'Memória salva.',
      'memorySaveFailed': 'Não foi possível salvar a memória. Tente novamente.',
      'optional': 'Opcional',
      'submitting': 'Salvando…',
      'memoryDateHint': 'AAAA-MM-DD',
      'mediaUrlHint': 'Link ou nota (opcional)',
      'changeImage': 'Alterar imagem',
      'imageSelected': 'Imagem selecionada',
      'imageRequirements': 'JPEG, PNG ou WebP até 5 MB.',
      'imageUploadFailed': 'Não foi possível enviar a imagem. Tente novamente.',
      'imageUploadSuccess': 'Memória e imagem salvas.',
      'unsupportedImageType':
          'Tipo de imagem não suportado. Use JPEG, PNG ou WebP.',
      'imageTooLarge': 'A imagem é muito grande (máximo 5 MB).',
      'memoryCreatedImageFailed':
          'Memória salva, mas não foi possível enviar a imagem. Você pode adicioná-la mais tarde.',
      'imagePreview': 'Pré-visualização da imagem',
      'imageUnavailable': 'Imagem indisponível',
      'memoryImage': 'Imagem da memória',
      'noImageAttached': 'Nenhuma imagem anexada',
      'memoryRecall': 'Recordação de memórias',
      'memoryRecallSubtitle': 'Lembre-se de momentos do seu álbum.',
      'whoIsThisPerson': 'Quem é esta pessoa?',
      'whereWasThisMemory': 'Onde foi esta memória?',
      'whatCategoryIsThisMemory': 'A que categoria pertence esta memória?',
      'correct': 'Correto',
      'tryAgain': 'Tentar novamente',
      'nextQuestion': 'Próxima pergunta',
      'finishExercise': 'Concluir',
      'recallComplete': 'Exercício concluído',
      'recallScore': 'Sua pontuação',
      'notEnoughMemories': 'Memórias insuficientes',
      'addMoreMemoriesToStart':
          'Adicione mais memórias para iniciar este exercício.',
      'memoryRecallLoadFailed':
          'Não foi possível iniciar a recordação de memórias. Tente novamente.',
      'reactionTime': 'Tempo de reação',
      'reactionTimeSubtitle':
          'Toque o mais rápido possível quando o sinal aparecer.',
      'startRound': 'Iniciar rodada',
      'waitForSignal': 'Aguarde…',
      'tapNow': 'Toque agora!',
      'tooSoon': 'Cedo demais! Aguarde o sinal.',
      'reactionTimeMs': 'Tempo de reação',
      'bestReaction': 'Melhor',
      'averageReaction': 'Média',
      'roundsCompleted': 'Rodadas',
      'reactionComplete': 'Exercício concluído',
      'attentionTap': 'Toque de atenção',
      'attentionTapSubtitle': 'Toque no alvo e ignore o resto.',
      'startAttentionTap': 'Começar',
      'tapTheTarget': 'Toque no alvo',
      'target': 'Alvo',
      'correctTap': 'Correto!',
      'missedTarget': 'Esse não era o alvo',
      'mistake': 'Erro',
      'accuracy': 'Precisão',
      'attentionComplete': 'Exercício concluído',
      'correctCount': 'Corretos',
      'sequenceRecall': 'Recordação de sequência',
      'sequenceRecallSubtitle': 'Observe a sequência e repita na ordem.',
      'startSequenceRecall': 'Começar',
      'watchSequence': 'Observe a sequência',
      'repeatSequence': 'Repita a sequência',
      'correctSequence': 'Correto!',
      'wrongSequence': 'Não exatamente',
      'longestSequence': 'Mais longa',
      'sequenceComplete': 'Exercício concluído',
    },
    'it': {
      'loginTitle': 'Accedi',
